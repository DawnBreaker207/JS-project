...
const registerPage = () => {
  return /*html*/ `
    ...
    <form action="" class="max-w-sm mx-auto">
        <h1 class="text-center font-medium block mb-2 text-gray-900 dark:text-white text-5xl my-6">Sign Up</h1>
        <div class="mb-5" >
        ...
        <button type="button" id="registerBtn" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Đăng ký</button>
    
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Đã có tài khoản. <a href="/login" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Đăng nhập</a> ngay!</p>
    </form>
        ${footerPage()}
    `;
};
